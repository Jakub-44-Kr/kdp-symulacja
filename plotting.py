...
# ═══════════════════════════════════════════════════════════════════════════
#  KONFIGURACJA GLOBALNA — wygląd wykresów (jednolity styl dla całej pracy)
# ═══════════════════════════════════════════════════════════════════════════
...
# Kolory dla faz (1=rozpędzanie, 2=ustalona, 3=coasting, 4=hamowanie)
PHASE_COLORS = {
    1: "#1f77b4",  # niebieski - rozpędzanie
    2: "#2ca02c",  # zielony - jazda ustalona
    3: "#ff7f0e",  # pomarańczowy - coasting
    4: "#d62728",  # czerwony - hamowanie
}
PHASE_NAMES = {
    1: "Rozpędzanie",
    2: "Jazda ustalona",
...
# ═══════════════════════════════════════════════════════════════════════════
#  POMOCNICZE — obcięcie artefaktów numerycznych z końca hamowania
# ═══════════════════════════════════════════════════════════════════════════
...
def _add_phase_regions(ax, sim: SimulationProfile, alpha: float = 0.08) -> None:
...
def _legend_phases(ax) -> None:
    ...
    handles = [
        Patch(facecolor=PHASE_COLORS[p], alpha=0.3, label=PHASE_NAMES[p])
        for p in (1, 2, 3, 4)
    ]
...
# ═══════════════════════════════════════════════════════════════════════════
#  WYKRES 1: PROFIL PRĘDKOŚCI v(x) - najważniejszy wykres
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
#  WYKRES 2: SIŁY DZIAŁAJĄCE NA POCIĄG
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
#  WYKRES 3: MOC I PRĄD NA PANTOGRAFIE
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
#  WYKRES 4: PROFIL CZASOWY v(t) - alternatywne ujęcie
# ═══════════════════════════════════════════════════════════════════════════
...
def plot_acceleration(
    ...
    x_km = sim.x / 1000.0
    # Obcinamy artefakty numeryczne z końca hamowania (ostatnie 3 punkty)
...
# ═══════════════════════════════════════════════════════════════════════════
#  WYKRES 6: BILANS ENERGII (słupkowy)
# ═══════════════════════════════════════════════════════════════════════════
...
def plot_energy_balance(
    ...
    values = [
        ...
        -energy.E_rec_pant * J_TO_KWH,  # ujemne (zwrot)
    ...
    ax.set_title(
        ...
        f"($\\approx$ {energy.E_per_seat_km:.1f} Wh/seat·km)"
    )
...
# ═══════════════════════════════════════════════════════════════════════════
#  WYKRES 7: PROFIL POCHYLEŃ TRASY (dla niejednorodnych profili)
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
#  WYKRES 8: CHARAKTERYSTYKA TRAKCYJNA F(v) - referencyjny
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
#  PANEL ZBIORCZY — wszystkie wykresy naraz
# ═══════════════════════════════════════════════════════════════════════════
